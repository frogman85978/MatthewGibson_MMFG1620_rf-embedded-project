...
extern "C" void app_main() {
    ...
    gpio_set_direction((gpio_num_t)IO_TOUCH_1, GPIO_MODE_INPUT);
    gpio_set_direction((gpio_num_t)IO_TOUCH_2, GPIO_MODE_INPUT);
    gpio_set_direction((gpio_num_t)IO_TOUCH_3, GPIO_MODE_INPUT);
